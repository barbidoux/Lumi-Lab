...
def tokenize_and_pack_sequences(
    ...
    try:
        ...
        # Step 5: Write to final binary files
...
def main():
    ...
    parser.add_argument("--sequence-length", type=int, default=1024, help="Sequence length for packing")
    parser.add_argument("--train-val-split", type=float, default=0.95, help="Train/validation split ratio")
